...
func create_armor_database():
	...
	if (!databaseFile.file_exists("res://databases/Armor.json")):
		...
		armorData["icon"] = ""
		armorData["description"] = "Light3D Clothes"
...
func _on_Tabs_tab_changed(tab):
	match(tab):
		0:
			$TabBar/Character.call("start")
		1:
			$TabBar/Class.call("start")
		2:
			$TabBar/Skill.call("start")
		3:
			$TabBar/Item.call("start")
		4:
			$TabBar/Weapon.call("start")
		5:
			$TabBar/Armor.call("start")
		6:
			$TabBar/Enemy.call("start")
		7:
			$TabBar/States.call("start")
		8:
			$TabBar/Effects.call("start")
		9:
			$TabBar/System.call("start")
...
func _on_AddEffectConfirm_pressed():
	...
	match (effect_manager_tab):
		"Character":
			$TabBar/Character.call("add_effect_list", name, dataType, value1, value2)
		"Class":
			$TabBar/Class.call("add_effect_list", name, dataType, value1, value2)
		"Skill":
			$TabBar/Skill.call("add_effect_list", name, dataType, value1, value2)
		"Item":
			$TabBar/Item.call("add_effect_list", name, dataType, value1, value2)
		"Weapon":
			$TabBar/Weapon.call("add_effect_list", name, dataType, value1, value2)
		"Armor":
			$TabBar/Armor.call("add_effect_list", name, dataType, value1, value2)
		"Enemy":
			$TabBar/Enemy.call("add_effect_list", name, dataType, value1, value2)
		"States":
			$TabBar/States.call("add_effect_list", name, dataType, value1, value2)
	effect_manager_tab = ""
	effect_data_type = ""
	$EffectManager.hide()
